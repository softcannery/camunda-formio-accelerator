...
//metaCSP.content = "style-src 'unsafe-inline' 'self' https://cdn.form.io/; connect-src 'self' 'unsafe-inline' 'unsafe-eval' https://api.form.io/ http://localhost:8080/ http://localhost:8081/; img-src 'self' data:; default-src 'self' 'unsafe-inline' 'unsafe-eval';";
