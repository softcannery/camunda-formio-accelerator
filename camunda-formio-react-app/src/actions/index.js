...
export const loadFormKeyByProcessId =
  (processDefinitionId) => (dispatch, getState) => {
...
export const startProcessInstance =
  (processDefinitionKey, values) => (dispatch, getState) => {
    return dispatch(
      ProcessDefinitionActions.postProcessInstance(
...
export const fetchFormDefinition =
  (processDefinitionId, taskId) => (dispatch, getState) => {
    const params = taskId !== null ? "?taskId=" + taskId : "";
    return dispatch(
      FormioActions.fetchFormDefinition(processDefinitionId, params),
    );
  };
