...
export const fetchProcessDefinitions = (processDefinitionId) => {
  if (processDefinitionId) {
    return {
      [CALL_API]: {
        types: [
          AT.PROCESS_DEFINITION_REQUEST,
          AT.PROCESS_DEFINITION_SUCCESS,
          AT.PROCESS_DEFINITION_FAILURE,
        ],
...
export const fetchProcessDefinitionXML = (processDefinitionId) => ({
  [CALL_API]: {
    types: [
      AT.PROCESS_DEFINITION_XML_REQUEST,
      AT.PROCESS_DEFINITION_XML_SUCCESS,
      AT.PROCESS_DEFINITION_XML_FAILURE,
    ],
...
export const postProcessInstance = (processDefinitionId, values) => ({
  [CALL_API]: {
    types: [
      AT.NEW_PROCESS_INSTANCE_REQUEST,
      AT.NEW_PROCESS_INSTANCE_SUCCESS,
      AT.NEW_PROCESS_INSTANCE_FAILURE,
    ],
    endpoint: `process-definition/${processDefinitionId}/start`,
